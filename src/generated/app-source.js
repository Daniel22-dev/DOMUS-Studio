/* GENERATED MODULE SOURCE – edit src/app/*.js and run npm run build. DOMUS Studio v7.3.0 */

/* BEGIN SOURCE: src/app/00-shell.js */
...
/* END SOURCE: src/app/00-shell.js */

/* BEGIN SOURCE: src/app/10-ui-foundation.js */
...
/* END SOURCE: src/app/10-ui-foundation.js */

/* BEGIN SOURCE: src/app/15-premium-foundation.js */
...
/* END SOURCE: src/app/15-premium-foundation.js */

/* BEGIN SOURCE: src/app/20-project-model.js */
...
/* END SOURCE: src/app/20-project-model.js */

/* BEGIN SOURCE: src/app/30-render-shell.js */
...
/* END SOURCE: src/app/30-render-shell.js */

/* BEGIN SOURCE: src/app/40-render-capture.js */
...
/* END SOURCE: src/app/40-render-capture.js */

/* BEGIN SOURCE: src/app/50-render-design.js */
...
/* END SOURCE: src/app/50-render-design.js */

/* BEGIN SOURCE: src/app/55-premium-design.js */
...
/* END SOURCE: src/app/55-premium-design.js */

/* BEGIN SOURCE: src/app/60-render-delivery.js */
/* Verify, Tender, BuildLog and PDF views. Source fragment; assembled by scripts/build.mjs. */
  ...
  // renderPdfTab is implemented by the premium fragment loaded later in the build.
/* END SOURCE: src/app/60-render-delivery.js */

/* BEGIN SOURCE: src/app/65-premium-report.js */
...
/* END SOURCE: src/app/65-premium-report.js */

/* BEGIN SOURCE: src/app/70-events-actions.js */
...
/* END SOURCE: src/app/70-events-actions.js */

/* BEGIN SOURCE: src/app/71-event-delegation.js */
...
/* END SOURCE: src/app/71-event-delegation.js */

/* BEGIN SOURCE: src/app/72-rendered-bindings.js */
...
/* END SOURCE: src/app/72-rendered-bindings.js */

/* BEGIN SOURCE: src/app/73-action-router.js */
...
/* END SOURCE: src/app/73-action-router.js */

/* BEGIN SOURCE: src/app/74-dialogs-active-view.js */
...
/* END SOURCE: src/app/74-dialogs-active-view.js */

/* BEGIN SOURCE: src/app/75-premium-actions.js */
...
/* END SOURCE: src/app/75-premium-actions.js */

/* BEGIN SOURCE: src/app/80-ai-field-sync.js */
...
/* END SOURCE: src/app/80-ai-field-sync.js */

/* BEGIN SOURCE: src/app/81-field-capture.js */
...
/* END SOURCE: src/app/81-field-capture.js */

/* BEGIN SOURCE: src/app/82-sync-client.js */
...
/* END SOURCE: src/app/82-sync-client.js */

/* BEGIN SOURCE: src/app/83-ai-visualizer-assistant.js */
...
/* END SOURCE: src/app/83-ai-visualizer-assistant.js */

/* BEGIN SOURCE: src/app/84-manual.js */
/* In-app manual and searchable operating guide. Source fragment; bundled by esbuild. */
  ...
  function openManualSection(section) {
    state.currentTab = 'manual'; state.manualSearch = ''; render();
    requestAnimationFrame(() => { const details = document.getElementById(`manual-${section}`); if (details) { details.open = true; details.scrollIntoView({ behavior: state.uiPreferences?.reduceMotion ? 'auto' : 'smooth', block: 'start' }); } });
  }

  function openManualDocument() { window.open('./MANUAL-DOMUS-STUDIO-v7.3.html', '_blank', 'noopener,noreferrer'); }
/* END SOURCE: src/app/84-manual.js */

/* BEGIN SOURCE: src/app/85-premium-sync.js */
...
/* END SOURCE: src/app/85-premium-sync.js */

/* BEGIN SOURCE: src/app/90-photo-plan-canvas.js */
...
/* END SOURCE: src/app/90-photo-plan-canvas.js */

/* BEGIN SOURCE: src/app/95-premium-plan-canvas.js */
...
/* END SOURCE: src/app/95-premium-plan-canvas.js */

/* BEGIN SOURCE: src/app/100-section-model-xr.js */
...
/* END SOURCE: src/app/100-section-model-xr.js */

/* BEGIN SOURCE: src/app/105-premium-3d.js */
...
/* END SOURCE: src/app/105-premium-3d.js */

/* BEGIN SOURCE: src/app/110-backup-export.js */
...
/* END SOURCE: src/app/110-backup-export.js */

/* BEGIN SOURCE: src/app/115-desktop-updater.js */
/* Tauri desktop update bridge. Web/PWA mode remains fully functional. */
  ...
  async function checkDesktopUpdates(manual=false){if(!isTauriDesktop()){if(manual)toast('Automatické desktopové aktualizace jsou dostupné v instalované verzi DOMUS Studio.');return;}const status=document.getElementById('desktopUpdateStatus');try{if(status)status.textContent='Kontroluji aktualizace…';const {check}=await import('./vendor/tauri-updater.js'),update=await check();if(!update){if(status)status.textContent='Používáte aktuální verzi.';if(manual)toast('DOMUS Studio je aktuální.');return;}if(status)status.textContent=`Dostupná verze ${update.version}.`;if(await confirmAction({ title: `Aktualizovat na verzi ${update.version}?`, message: 'Aktualizace se stáhne z podepsaného kanálu, nainstaluje a aplikace se znovu spustí.', acceptLabel: 'Stáhnout a nainstalovat' })){await update.downloadAndInstall();const {relaunch}=await import('./vendor/tauri-process.js');await relaunch();}}catch(error){if(status)status.textContent='Kontrola aktualizací selhala.';if(manual)toast(error.message||'Aktualizaci se nepodařilo ověřit.','error');}}
  function scheduleDesktopUpdateCheck(){if(!isTauriDesktop())return;setTimeout(()=>checkDesktopUpdates(false),3500);}
/* END SOURCE: src/app/115-desktop-updater.js */

/* BEGIN SOURCE: src/app/120-canvas-utils-init.js */
...
/* END SOURCE: src/app/120-canvas-utils-init.js */
